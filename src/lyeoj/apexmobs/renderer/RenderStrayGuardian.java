...
import lyeoj.apexmobs.model.ModelStrayGuardian;
...
public class RenderStrayGuardian extends RenderLiving<EntityStrayGuardian>
{
    private static final ResourceLocation GUARDIAN_TEXTURE = new ResourceLocation("apexmobs:textures/entity/strayguardian.png");
    private static final ResourceLocation GUARDIAN_BEAM_TEXTURE = new ResourceLocation("textures/entity/guardian_beam.png");
    public static final Factory FACTORY = new Factory();

    public RenderStrayGuardian(RenderManager renderManagerIn)
    {
        super(renderManagerIn, new ModelStrayGuardian(), 0.5F);
    }

    public boolean shouldRender(EntityStrayGuardian livingEntity, ICamera camera, double camX, double camY, double camZ)
    {
	...
	public void doRender(EntityStrayGuardian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        if (entitylivingbase != null)
        {
            ...
            float f7 = f * f;
            int j = 128 + (int)(f7 * 191.0F);
            int k = 32 + (int)(f7 * 191.0F);
            int l = 64 - (int)(f7 * 64.0F);
            double d2 = 0.2D;
            double d3 = 0.282D;
     ...
     */
    protected ResourceLocation getEntityTexture(EntityStrayGuardian entity)
    {
        return GUARDIAN_TEXTURE;
    }
    
    public static class Factory implements IRenderFactory<EntityStrayGuardian> {
      	 
        @Override
        public Render<? super EntityStrayGuardian> createRenderFor(RenderManager manager) {
            return new RenderStrayGuardian(manager);
        }
    }
}
